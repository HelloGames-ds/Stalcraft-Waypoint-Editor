...
class SimpleMapperDesktopApp(
    ...
    def create_ui(self) -> None:
        ...
        with dpg.window(tag="main_window", label="SimpleMapper Desktop"):
            with dpg.group(horizontal=True):
                with dpg.child_window(tag="sidebar", width=int(self.ui_config["sidebar_width"]), border=True):
                    dpg.add_text("SimpleMapper Desktop", color=(245, 245, 245))
                    dpg.add_text("Локальный viewer без браузера", color=(150, 195, 255))
